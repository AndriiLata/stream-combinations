...
import com.gendev.streamcombinations.service.searching.SearchAlgorithm;
...
public class CheapestPackageCombi {
    ...
    public Map<String, Object> cheapestPackagesForTeams(List<String> teams) {
        ...
        return SearchAlgorithm.findOptimalPackages(gPFT, servicePricesYearlySubscription, gameIDs);
    }


    public static void main(String[] args) {
        CheapestPackageCombi cpc = new CheapestPackageCombi();
        List<String> teams = List.of("Hatayspor", "Deutschland", "Bayern München", "Real Madrid");
